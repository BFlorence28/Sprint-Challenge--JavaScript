...
const lowPopulationAnimals = zooAnimals.filter(word => word.population < 5);
...
*/
let populationTotal = 0; //<--empty array?
const num = [];

for (var i= 0; i<zooAnimals.length; i++){
  // console.log(zooAnimals[i].population); - check codepen
  num.push(zooAnimals[i].population);
}

// console.log(num); - check codepen

function getSum(total, numb) {
  return total + numb
}

populationTotal = num.reduce(getSum, 0);
